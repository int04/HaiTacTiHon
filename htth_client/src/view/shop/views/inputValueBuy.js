...
export default (self, id, callback) => {
    let chat = (self,text = '') => {
        self.closeInput();
        let number = parseInt(text);
        if(number > 0) {
            callback(self,id,number);
        }
    ...
    head.alpha = 1;
    let text = new PIXI.Text(self._('Mua vật phẩm'),{
        fontFamily: 'Arial',
        fontSize: 16,
        fill: 0xffffff,
        align: 'center'
    ...
    let text2 = new PIXI.Text(self._('Nhập số lượng cần mua:'),{
        fontFamily: 'Arial',
        fontSize: 16,
        fill: 0xffffff,
        align: 'center'
    ...
    let text3 = new PIXI.Text(self._('OK'),{
        fontFamily: 'Arial',
        fontSize: 16,
        fill: 0xffffff,
        align: 'center'
